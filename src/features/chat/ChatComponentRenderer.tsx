...
import { AddressConfirmCard, AdminHandoffCard, CustomerConfirmCard, OrderStatusCard, OrderSummaryCard, PaymentUploadCard, PhoneOtpCard } from './components/SimpleCards';
  ...
  return (
    <div className="w-full space-y-3">
      {components.map((component, index) => {
        ...
        if (component.type === 'phone_otp') return <PhoneOtpCard key={index} component={component} onSend={onSend} />;
